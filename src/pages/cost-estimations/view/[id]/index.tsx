...
import { getCostEstimationById } from 'apiSdk/cost-estimations';
...
function CostEstimationViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Cost Estimation Detail View
          </Text>
          {hasAccess('cost_estimation', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/cost-estimations/edit/${data?.id}`} passHref legacyBehavior>
              <Button
